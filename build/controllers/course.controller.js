...
exports.editCourse = (0, catchAsyncError_1.CatchAsyncError)(async (req, res, next) => {
    try {
        ...
        const thumbnail = data.thumbnail;
        if (thumbnail) {
            await cloudinary_1.default.v2.uploader.destroy(thumbnail);
            const myCloud = await cloudinary_1.default.v2.uploader.upload(thumbnail, {
                folder: "courses",
            });
            data.thumbnail = {
...
exports.addAnswer = (0, catchAsyncError_1.CatchAsyncError)(async (req, res, next) => {
    try {
        ...
        // add this answer to your course content
...
exports.addReview = (0, catchAsyncError_1.CatchAsyncError)(async (req, res, next) => {
    try {
        ...
        if (course) {
            course.ratings = avg / course.reviews.length; //on example we have 2 reviews one is 5 another one is 4
        }
        await course?.save();
        await redis_1.redis.set(courseId, JSON.stringify(course), "EX", 604800);
        //   create notification
